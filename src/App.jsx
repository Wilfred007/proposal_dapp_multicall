...
function App() {
    ...
    const handleProposalCreated = () => {
        console.log("New proposal created... updating UI");
        fetchProposals();
    }

    const handleVoted = (updatedResponse) => {
        console.log("Proposal voted for... updating UI");
        // updateProposals(Number(updatedResponse));
    }
